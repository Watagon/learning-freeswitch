...
docker build $progress_option $cache_option -t freeswitch-with-sngrep2 --build-arg user_name=$git_user_name --build-arg git_user_name=$git_user_name --build-arg git_user_email=$git_user_email .
